	...
	public TelaContador() {
		...
		btnCont.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DefaultListModel lista = new DefaultListModel(); // criando objeto chamado lista que é um
																	// DefaultListModel

				for (int c = i; c <= f; c += p) { // c começa no inicio, enquanto ele for <= fim ele vai somando o passo
