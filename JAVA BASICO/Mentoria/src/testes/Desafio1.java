...
public class Desafio1 {
	 ...
	 * dos valores ímpares digitados 4- Valores acima de 100 digitados 5- Média dos
	 * valores digitados
	 */
	public static void main(String[] args) {
		...
		System.out.println("Digite um número ou digite 0 para interromper: ");
		escolha = scanner.nextInt();

		while (escolha != 0) {
			// System.err.println("Variável total digi antes da soma " + totalDigi);
			...
			// System.out.println();
			// System.err.println("Variável total digi depois da soma " + totalDigi);
			// System.out.println();
			if (escolha % 2 == 0) {
				totalPar = totalPar + 1;
			}
		...
		System.out.println("O total dos valores ímpares digitados: " + totalImpar);
		System.out.println("Os valores acima de 100 digitados: " + acimaCem);
		System.out.format("A média dos valores digitados: %.2f ", media);
	}
}
